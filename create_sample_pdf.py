...
def create_pdf(filename):
    ...
    c.setTitle("Relatório Financeiro SuperTechIABrazil")
    
    # Header
    c.setFont("Helvetica-Bold", 14)
    c.drawString(100, 750, "Relatório Financeiro Confidencial - SuperTechIABrazil")
    ...
    c.drawString(100, 700, "O faturamento da Empresa SuperTechIABrazil foi de 10 milhões de reais em 2023.")
